...
test('release home tabs fixture populates the visible native archive feed', () => {
  ...
  assert.match(fixture, /action: 'createCollaboration'/)
  assert.match(fixture, /collaborationTemplateId: 'collaboration-template-carpool'/)
  assert.ok(fixture.indexOf("action: 'apply', communityId: fixture.communityId") < fixture.indexOf("action: 'createCollaboration'"))
